...
const body = win("body");
const curriculumId = body.innerHTML.split("curriculumId")[1].split(",")[0];
const curriculumIdNumber = curriculumId.match(/\d+/g);
